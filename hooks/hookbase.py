class HookBase:
    ...
    trainer: "pytorch_utils.Trainer" = None # type:ignore
    priority: int = 5
    ...
    @property
    def metric_storage(self) -> "pytorch_utils.MetricStorage": # type:ignore
    ...
    def is_last_inner_iter(self) -> bool:
        """Returns True if the current inner iteration is the last inner iteration."""
